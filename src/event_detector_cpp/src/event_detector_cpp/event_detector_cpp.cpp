...
: NodeBase("event_detector_cpp", node_options, true)
{
  dua_init_node();
...
{
  pub_sae_ = dua_create_publisher<sensor_msgs::msg::Image>(
    "~/sae_image",
...
RCLCPP_COMPONENTS_REGISTER_NODE(event_detector_cpp::EventDetector)
